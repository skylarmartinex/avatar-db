...
export async function POST(request: NextRequest) {
    try {
        ...
        const { BASE, SUBJECT_TYPE, FACE, BODY, HAIR, ETHNICITY, SKIN, OUTFIT, POSE, BACKGROUND, v, r } = body;
        ...
        const result = await buildPrompt({
            BASE, SUBJECT_TYPE, FACE, BODY, HAIR, ETHNICITY, SKIN, OUTFIT, POSE, BACKGROUND,
            v: v || '01',
            r: r || '01'
        });
